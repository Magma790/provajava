...
public class FormCadCategoria implements ActionListener {
	...
	//Passo 4.2 - Verificar se criou um botão
	...
	public FormCadCategoria() {
		...
		//Passo 6 - Verificar se instânciou o JFrame
		JFrame frmCategoria = new JFrame("Escola Java- SENAI Brasília");
		
		//Passo 6.1 - Verificar se instânciou o JTextField
		...
		//Passo 8.1 - Verificar se adicionou comandos de ação
		btnCadastrar.setActionCommand("cadastrar");
		btnBuscarId.setActionCommand("buscarId");
		btnAtualizar.setActionCommand("atualizar");
		
		//Passo 8.1 Verificar se adiciona o evento ao botão (ouvinte)
		...
		//Passo 9 - Verificar se o aluno programou o encerramento do programa quando o usuário fecha o aplicativo
		frmCategoria.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		//Passo 9.1 Verificar se adicionou um código para centralizar
	...
	//Passo 3.1 - Verificar se o método actionPerfomed da Interface ActionListener foi implementada com override (sobrescrita) o verdadeiro polimorfismo segundo especialistas mundiais Java.
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("cadastrar")) {
			...
			JOptionPane.showMessageDialog(null,"Atualizar em Manutenção!");
			/*
			CategoriaDao cDao = new CategoriaDao(em);
			em.getTransaction().begin();
			em.merge(c);
